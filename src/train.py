...
# Единый лимит на класс по исходным файлам.
# None = автоматически = минимум среди всех классов.
...
def compute_global_limit() -> int:
    """Считает минимальное число файлов среди всех классов."""
...
# ---------------------------------------------------------------------------
# Метрики, модель, main — без изменений
# ---------------------------------------------------------------------------
